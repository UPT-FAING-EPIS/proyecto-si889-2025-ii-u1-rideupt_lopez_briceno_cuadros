...
| propuesto**:                    |                                    |
|                                 |                                    |
| *Hop Hop – Conecta tu camino    |                                    |
| universitario, Tacna 2024*     |                                    |
+=================================+====================================+
...
| móvil de carpooling que         |                                    |
| conecte estudiantes             |                                    |
| universitarios para facilitar   |                                    |
| el transporte compartido,       |                                    |
| reduciendo costos de movilidad  |                                    |
...
|     para Android e iOS.         |                                    |
| -   Reducción del 60-70% en     |                                    |
|     costos de transporte para   |                                    |
|     estudiantes.                 |                                    |
| -   Plataforma segura con       |                                    |
...
| Tacna), con enfoque inicial en  |                                    |
| Tacna. Se estima una población  |                                    |
| objetivo de 1.2 millones de     |                                    |
...
|----|---------------|-------------|-----------|
| RF001 | Autenticación de Usuario | Sistema de registro y login con validación estudiantil | CRÍTICA |
| RF002 | Gestión de Perfiles | Creación y edición de perfiles de conductor/pasajero | CRÍTICA |
| RF003 | Creación de Viajes | Publicación de viajes con geolocalización automática | CRÍTICA |
| RF004 | Búsqueda de Viajes | Visualización de viajes disponibles con filtros | CRÍTICA |
| RF005 | Sistema de Reservas | Solicitud y aprobación de reservas de viajes | ALTA |
| RF006 | Geolocalización | Detección automática de ubicación y selección de destinos | ALTA |
| RF007 | Cálculo de Precios | Determinación automática de precios basada en distancia | ALTA |
| RF008 | Notificaciones | Sistema de notificaciones push en tiempo real | ALTA |
| RF009 | Gestión de Viajes | Historial personal y detalles de viajes | MEDIA |
| RF010 | Expiración Automática | Caducidad automática de viajes (10 minutos) | MEDIA |

### **Requerimientos No Funcionales**

| ID | Requerimiento | Descripción | Prioridad |
|----|---------------|-------------|-----------|
| RNF001 | Rendimiento | Tiempo de respuesta < 2 segundos | CRÍTICA |
| RNF002 | Disponibilidad | Uptime del 99.5% | CRÍTICA |
| RNF003 | Seguridad | Encriptación AES-256 y JWT | CRÍTICA |
| RNF004 | Usabilidad | Interfaz intuitiva Material Design 3 | ALTA |
| RNF005 | Escalabilidad | Arquitectura preparada para crecimiento | ALTA |
| RNF006 | Compatibilidad | Android 6.0+ e iOS 12.0+ | ALTA |
| RNF007 | Conectividad | Funcionamiento con conexión móvil | MEDIA |
| RNF008 | Privacidad | Cumplimiento Ley Protección Datos | MEDIA |
...
- **Viajes Completados**: 500 en el primer mes
...
### **Hito 1: Documentación Completa (Semana 4)**
...
### **Hito 2: MVP Funcional (Semana 12)**
...
El proyecto se financiará mediante una combinación de:
...
| Categoría | Concepto | Costo (S/.) | Porcentaje | Justificación |
|-----------|----------|--------------|------------|---------------|
| **Desarrollo** | Salarios del equipo | 45,000 | 66% | 5 meses × 3 desarrolladores × S/. 3,000 |
| **Infraestructura** | Servidores cloud | 8,000 | 12% | AWS/Google Cloud por 12 meses |
| **Servicios** | Google Maps API | 3,000 | 4% | Licencias y uso por 12 meses |
| **Servicios** | Firebase FCM | 2,000 | 3% | Servicios de notificación |
| **Servicios** | MongoDB Atlas | 2,500 | 4% | Base de datos en la nube |
| **Marketing** | Promoción inicial | 3,000 | 4% | Campañas en universidades |
| **Legal** | Consultoría legal | 1,500 | 2% | Cumplimiento normativo |
| **Contingencia** | Imprevistos | 3,210 | 5% | 5% del total |
| **TOTAL** | | **68,210** | **100%** | |
...
### **RF001 - Sistema de Autenticación**
